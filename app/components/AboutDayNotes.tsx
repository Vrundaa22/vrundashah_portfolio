...
const DAY_NOTES: DayNote[] = [
  {
    ...
    tag: "pre-figma",
    label: "open the file",
    teaser: "yogurt bowl, eggs, avocado toast → duplicate yesterday's chaos",
  ...
  },
  {
    id: "crit",
    time: "12:00",
    tag: " Job apps don't stop ",
    label: "apply, coffee chat, make projects",
    teaser: "cs × design student, pins out",
  ...
  return (
    <section className="about-day" aria-label="Day in the life of a design student">
      <div className="about-day-header">
        ...
        <h2 className="about-day-title">20 year old summer day edition</h2>
